            ...
            <div className='mt-14'>
                <Grid style='items-center gap-x-4'>
                    ...
                    <form className='col-span-12 sm:col-span-6 bg-vgray p-5 rounded-md' onSubmit={handleSubmit}>
                        ...
                        <Input for='phone' type='text' label='رقم الهاتف'  value={phone} onType={(e) => setPhone(e.target.value)} />
                        { errors.phone && <AlertMsg msg={errors.phone} category='vred' /> }
                        <Input for='pass' type='password' label='كلمة المرور' value={pass} onType={(e) => setPass(e.target.value)} />
