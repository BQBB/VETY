...
export default function NotFound() {
    return (
        <div class="h-screen w-screen flex items-center">
            <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-vblue">
                <div class="max-w-md">
                    <div class="text-5xl font-dark font-bold">404</div>
                    <p class="text-2xl md:text-3xl font-light leading-normal">الصفحة غير موجودة.</p>
                    <p class="mb-8">لكن لا تقلق ، يمكنك العثور على الكثير من الأشياء الأخرى على صفحتنا الرئيسية.</p>
                    <Link to='/' class="px-4 inline py-2 text-sm font-medium leading-5 shadow bg-vblue text-vgray transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-vblue active:bg-vblue hover:shadow-md">الذهاب للصفحة الرئيسية</Link>
                </div>
                {/* <div class="max-w-lg">
                    <svg
                    id="Layer_1"
