    ...
    <>
        ...
        <Grid>
            <GridItem style="md:col-span-6 mt-10 md:mt-[60px] order-3 md:order-[0]">
                ...
                <div className="flex mt-4 gap-x-4 text-vsm">
                    <button className="bg-vblue text-white px-8 py-2 rounded-lg shadow-lg">إنشاء حساب</button>
                    <button className="px-8 py-2 bg-white border border-vblue rounded-lg text-vblue">تسجيل الدخول</button>
                </div>
            </GridItem>
        ...
        <Container>
                <div className='flex justify-between items-center mt-14'>
                    ...
                    <Link to={'/clinics'} className="text-vblue bg-vgray px-4 md:px-8 text-vsm py-2 rounded-lg hover:shadow-md">عرض المزيد</Link>
                </div>
                <Grid style='mt-10 gap-x-8 gap-y-4'>
