        ...
        <Grid>
            <GridItem style="md:col-span-6 mt-10 md:mt-[60px] order-3 md:order-[0]">
                ...
                <div className="flex mt-4 gap-x-4 text-vsm">
                   {!isAuthed && (<><Link to='/register' className="bg-vblue text-white px-8 py-2 rounded-lg shadow-lg">إنشاء حساب</Link> <Link to='/login' className="px-8 py-2 bg-white border border-vblue rounded-lg text-vblue">تسجيل الدخول</Link></>)}
                </div>
            </GridItem>
                        ...
                        clinics.map((clinic,i)=>{
                            return (
                                <GridItem style={`sm:col-span-6 md:col-span-4 `} key={i}>
                                        <Link to='/clinic'>
                                            <ClinicCard name={clinic.clinic_name} location={clinic.user.address.city.name+" - "+clinic.user.address.zone.name} bg='bg-white' rate={clinic.rating_average} />
                                        </Link>
                                </GridItem>
                            )
                        })
